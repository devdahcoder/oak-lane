...
const BookDemo = (props: Props) => {
	return (
		<div className="flex flex-col items-center font-cabin pt-20 pb-10 space-y-12">
			<ContainerSize className="flex flex-col items-center justify-center text-center w-[75%] gap-y-7">
				<div className="relative flex flex-col items-center justify-center text-6xl font-semibold leading-[5rem] tracking-wide">
					<h1>
						Engage your{" "}
						<span className="relative">
							{" "}
							<Stripe className="absolute bottom-1 left-0 -z-50" />{" "}
							audience
						</span>{" "}
						and make everyone feel connected
					</h1>
				</div>

				<div className="flex flex-col items-center justify-center text-base px-24 font-raleway font-semibold">
					<p>
						whether you’re running a team call, training or an
						all-company meeting, OakLane gives you everything you
						need to engage your participants.
					</p>
				</div>
				...
				<div>
					<Button
						...
						className={`bg-green-100 text-white rounded-full py-3 px-6`}
