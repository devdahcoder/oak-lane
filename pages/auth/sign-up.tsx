...
const SignUp = (props: Props) => {
    ...
    return (
        <div className="flex flex-row items-center justify-center min-h-screen">
            <ContainerSize className={`w-full max-w-md my-10 flex flex-col space-y-5`}>
                ...
                <div className="flex flex-col items-center justify-center text-center space-y-5">
                    <div>
                        <Link href={`/auth/login`}>
                            <a className="text-blue-300 ">I have an account</a>
                        </Link>
                        
                    </div>
                    <div>
                        <div className="text-dark-200">Signing up for OakLane means you agree to the <a className="text-blue-300 " href="http://" target="_blank" rel="noopener noreferrer">
                            Privacy Policy</a> and</div>
                        <a className="underline text-blue-300 " href="http://" target="_blank" rel="noopener noreferrer">Terms of Service</a>
                    </div>
                </div>
            </ContainerSize>
        </div>
